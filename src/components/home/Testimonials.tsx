...
export function Testimonials() {
  ...
  return (
    <section ref={ref} className="reveal mb-16">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-accent/25 bg-gradient-to-br from-primary via-primary to-accent p-8 text-primary-foreground shadow-elegant sm:p-12">
        <span
          aria-hidden
        ...
        />
        <Quote
          className="absolute -top-2 left-4 size-20 text-gold/25 sm:-top-4 sm:left-8 sm:size-32"
          strokeWidth={1.5}
        />
