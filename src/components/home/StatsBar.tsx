...
export function StatsBar() {
  ...
  return (
    <div
      ref={ref}
      className="reveal group relative mb-10 md:mb-16 grid grid-cols-2 gap-3 overflow-hidden rounded-[5px] border border-border bg-[image:var(--gradient-primary)] p-5 text-white shadow-lg sm:p-6 md:grid-cols-4 md:gap-6"
    >
