...
/** Returns true when the current tree is already wrapped by SidebarProvider. */
function useIsInsideSidebarProvider() {
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      className={cn(
        "relative h-10 w-10 rounded-full border border-border/60 bg-background/70 shadow-sm backdrop-blur-md",
        "transition-all duration-300 ease-out hover:bg-accent hover:shadow-md hover:scale-105 active:scale-95",
